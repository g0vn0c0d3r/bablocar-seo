...
- Блок находится в корзине "делим", но текущие карточки частично повторяются.
...
- оставить блок источником уникальности, но не менять его дизайн от страницы к странице;
