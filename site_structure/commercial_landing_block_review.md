...
- Проверяем не условия офферов, а сам блок: H2, таблицу и CTA.
- Офферы временные, их разберем отдельно.

### Решение

- H2: `Варианты от партнеров`;
- таблица офферов выглядит одинаково на всех типах страниц;
- CTA: `Подать заявку`;
- офферы дорабатываем позже.
