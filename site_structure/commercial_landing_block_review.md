...
- Офферы сейчас временные, поэтому не оцениваем сами условия.
- Проверяем только структуру, название блока и дизайн.

### Решение

- оставить блок как витрину вариантов от партнеров;
- привести название, дизайн таблицы и CTA к одному виду;
- не использовать временные офферы как финальные обещания;
